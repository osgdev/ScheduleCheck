 ...
 * However, you can still intercept them with a custom output stream, which is especially 
 * useful when you have to log data that third-party libraries write to the standard streams.
